({
  ...
  /*
   * Subscribes to the platform event channel using a shared CometD connection.
   */
  ...
  subscribe: function (component, event, helper) {
    ...
    const callback = function (message) {
      ...
      this.onReceiveNotification(component, message);
    };
    // Subscribe to the channel and save the returned subscription object.
    empApi.subscribe(channel, replayId, $A.getCallback(callback)).then($A.getCallback(
  ...
  /*
   * This function is called when a platform event message is received. 
   * 
   * This function formats the platform event data, adds it to the notification history, 
   * and displays a toast if you have not muted notifications.
   */ 
