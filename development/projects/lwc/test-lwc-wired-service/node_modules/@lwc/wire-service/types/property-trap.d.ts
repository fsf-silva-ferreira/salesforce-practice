 ...
 */
export declare function updated(cmp: EventTarget, reactiveParameters: Array<ReactiveParameter>, configContext: ConfigContext): void;
/**
 * Gets the value of an @wire reactive parameter.
 * @param cmp The component
 * @param reactiveParameter The parameter to get
 */
export declare function getReactiveParameterValue(cmp: EventTarget, reactiveParameter: ReactiveParameter): any;
/**
 ...
 * @param configContext The service context
 */
export declare function installTrap(cmp: EventTarget, reactiveParametersHead: string, reactiveParameters: Array<ReactiveParameter>, configContext: ConfigContext): void;
/**
