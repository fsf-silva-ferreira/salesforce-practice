...
declare module "@salesforce/schema/Account.Has_Support_Plan__c" {
  const Has_Support_Plan__c:boolean;
  export default Has_Support_Plan__c;
}
declare module "@salesforce/schema/Account.Support_Plan_Expiration_Date__c" {
  const Support_Plan_Expiration_Date__c:any;
  export default Support_Plan_Expiration_Date__c;
}
declare module "@salesforce/schema/Account.Region__c" {
  const Region__c:string;
  export default Region__c;
}
declare module "@salesforce/schema/Account.Zone__c" {
  const Zone__c:string;
  export default Zone__c;
}
declare module "@salesforce/schema/Account.Opportunity_Sum__c" {
  const Opportunity_Sum__c:number;
  export default Opportunity_Sum__c;
}
