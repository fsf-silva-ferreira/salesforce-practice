...
declare module "@salesforce/schema/Case.Backup_Agent__r" {
  const Backup_Agent__r:any;
  export default Backup_Agent__r;
}
declare module "@salesforce/schema/Case.Backup_Agent__c" {
  const Backup_Agent__c:any;
  export default Backup_Agent__c;
}
