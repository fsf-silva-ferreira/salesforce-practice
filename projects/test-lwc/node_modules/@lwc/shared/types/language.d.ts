...
}, getOwnPropertyDescriptor: (o: any, p: string | number | symbol) => PropertyDescriptor | undefined, getOwnPropertyNames: (o: any) => string[], getPrototypeOf: (o: any) => any, hasOwnProperty: (v: string | number | symbol) => boolean, keys: {
    (o: object): string[];
    (o: {}): string[];
